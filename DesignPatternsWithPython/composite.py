...
class Composite(Component): #Inherits from abstract class Component
    '''Concreate class that maintains the tree recursive structure'''
    def __init__(self, *args, **kwargs):
        Component.__init__(self, *args, **kwargs)
    ...
    def component_function(self):
        ...
        #Iterate through child objects and inovke their component
        #function printing their name
